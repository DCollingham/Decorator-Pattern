...
{
    //Can not exist alone
    public class OnionAddon : Decorator.BurgerDecorator
    {
        ...
        public OnionAddon(Burger burger)
        {
            this._burger = burger;
        }

        //Takes passed-in description and adds topping to it
        public override string Description => _burger.Description + " + Onions";
